...
def svhn_decoder(z, z_sampled, numLatent, numHidden, mb_size):
    ...
    o3 = DeConvLayer(o2.output, in_channels = deconv_shapes[2], out_channels = deconv_shapes[3], kernel_len = 5, in_rows = 16, in_columns = 16, batch_size = 100, bias_init = 0.0, name = 'o3', paramMap = None, upsample_rate = 2, activation = None)
